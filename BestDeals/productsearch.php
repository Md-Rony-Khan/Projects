		...
		<div class="container">
			...
			<div class="row">
                ...
                <?php
                      ...
                      $query = "select * from  tbl_allproduct";
                 ...
                 ?>
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									...
									<div class="product-body">
										<h3 class="product-price <?php echo $result['id'];?>"><?php echo $result['price'];?> <del class="product-old-price">$45.00</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
										...
										<h2 class="product-name"><a href="#"><?php echo $result['name'];?></a></h2>
					...
					<!-- store bottom filter -->
					<div class="store-filter clearfix">
						<div class="pull-left"> <?php }  ?><!--end while loop-->
