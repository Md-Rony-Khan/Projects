					...
					<ul class="header-btns">
						...
						<li class="header-account dropdown default-dropdown">
							<div class="dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="true">
								...
								<strong class="text-uppercase">My Profile <i class="fa fa-caret-down"></i></strong>
							</div>
							...
							<?php } ?>
								...
								<li><a href="compare.php"><i class="fa fa-exchange"></i> Compare</a></li>
								<li><a href="#"><i class="fa fa-check"></i> Checkout</a></li>
                            <?php

                                 $login = Session::get("custlogin");
                                 if($login ==false){   ?>
                                 	<li><a href="userregis.php"><i class="fa fa-unlock-alt"></i> Login</a></li>
                                <?php } else { ?>
							...
							<div class="custom-menu">
								<div id="shopping-cart">
									...
									<div class="shopping-cart-btns">
											<ul class="custom-menu">
										<?php
										   $chkCart = $cart->getCartProduct();
										   if($chkCart)	{ ?>
										    	<li><a href="cart_page.php"><i class="fa fa-user-o"></i> View Cart</a></li>
